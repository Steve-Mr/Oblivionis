...
import top.maary.oblivionis.ui.GroupPosition
import top.maary.oblivionis.ui.SettingsItem
...
fun SettingsScreen(
    ...
    Scaffold(topBar = {
        ...
        LazyColumn(
            ...
            item {
                SettingsItem( position = if (notificationState.value) GroupPosition.TOP else GroupPosition.SINGLE) {
                    SwitchRow(
            ...
            item {
                if (notificationState.value) {
                    ...
                    SettingsItem( position = if(notificationIntervalFixed.value) GroupPosition.MIDDLE else GroupPosition.BOTTOM) {

                        TimePickerItem(
                            title = stringResource(R.string.notfication_time),
